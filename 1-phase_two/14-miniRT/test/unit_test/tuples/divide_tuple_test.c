...
Test(tuples, test_divide_tuple_2__1_minus_2_3_minus_4) {
	t_coordinates	a = {.x = 1, .y = -2, .z = 3, .w = -4};
	t_coordinates	expected = {.x = 0.5, .y = -1, .z = 1.5, .w = -2};
	t_coordinates	result = divide_tuple(2, a);
...
Test(tuples, test_divide_tuple_0_point_5__1_minus_2_3_minus_4) {
	t_coordinates	a = {.x = 1, .y = -2, .z = 3, .w = -4};
	t_coordinates	expected = {.x = 2, .y = -4, .z = 6, .w = -8};
	t_coordinates	result = divide_tuple(0.5, a);
