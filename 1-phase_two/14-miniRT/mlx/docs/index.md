...
It returns a t_mlx* which is a structure containing the current window instance.
...
**g_mlx_errno** and **mlx_strerror** to properly identify what went wrong during the runtime
of the library.
